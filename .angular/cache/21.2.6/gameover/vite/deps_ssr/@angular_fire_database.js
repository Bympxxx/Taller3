...
var require_parser = __commonJS({
  "node_modules/websocket-extensions/lib/parser.js"(exports, module) {
    ...
    Offers.prototype.push = function(name3, params) {
      if (!hasOwnProperty.call(this._byName, name3))
        this._byName[name3] = [];
      this._byName[name3].push(params);
      this._inOrder.push({ name: name3, params });
    };
    Offers.prototype.eachOffer = function(callback, context) {
      var list3 = this._inOrder;
      for (var i = 0, n = list3.length; i < n; i++)
        callback.call(context, list3[i].name, list3[i].params);
    };
...
var require_functor = __commonJS({
  "node_modules/websocket-extensions/lib/pipeline/functor.js"(exports, module) {
    ...
    Functor.prototype.call = function(error3, message, callback, context) {
      ...
      var record = { error: error3, message, callback, context, done: false }, called = false, self = this;
    ...
    var instance = {
      ...
      activate: function(header) {
        ...
        responses.eachOffer(function(name3, params) {
          ...
          if (!record)
            throw new Error('Server sent an extension response for unknown extension "' + name3 + '"');
          ...
          if (session.activate(params) !== true)
            throw new Error("Server sent unacceptable extension parameters: " + Parser.serializeParams(name3, params));
          this._reserve(ext);
          sessions.push(record);
        }, this);
        this._sessions = sessions;
